export const SITE = {
  title: 'Офіційний сайт ОСББ "Синевирій"',
  description:
    'Вітаємо на офіційному сайті ОСББ «Синевирій». Тут ви можете знайти інформацію про наш будинок, контакти адміністраці та інше.',
  name: 'ОСББ "Синевирій"',
};
...
export const WELCOME = {
  titleLines: ['Вітаємо на офіційному сайті ', 'ОСББ “Синевирій”'],
  text:
    'Тут ви можете знайти інформацію про наш будинок, переглянути новини та оголошення, ознайомитись з публічними документами, знайти контакти адміністрації та виконавців.',
};

export const ABOUT_OSBB = {
  title: 'Про ОСББ “Синевирій”',
  text:
    'ОСББ “Синевирій” було створено 24 серпня 2024 року з метою управління багатоквартирним житловим будинком, розташованим за адресою: Київ, вулиця Бориса Гмирі, 777.',
};

export const MISSION = {
  title: 'НАША МІСІЯ',
  text:
    'Утримувати будинок у належному технічному та санітарному стані, забезпечити надання якісних комунальних послуг та комфортне проживання.',
};

export const HOUSE = {
  title: 'НАШ БУДИНОК',
  html:
    'Житловий будинок розташований на відстані 500 м від станції метро “Позняки”, навпроти – озеро Срібний кіл. Будинок складається з чотирьох секцій та має 16 поверхів, в плані нагадує латинську букву S з внутрішнім двором. На першому поверсі розміщені продовольчий магазин, аптека, салон краси і банк. З другого поверху починаються одно, двох, трьох і чотирьохкімнатні квартири. У кожну квартиру проведено лінії телефонного зв’язку, кабельного інтернету і телебачення. Прилегла до будинку територія огороджена, тротуари вимощені плиткою, навколо будинку облаштована паркова зона. Також на прибудинковій території розміщені автостоянка, спортивний і дитячий майданчики.',
};

export const STATS = [
  { number: '13540', label: 'ЗАГАЛЬНА ЖИТЛОВА ПЛОЩА' },
  { number: '650', label: 'КІЛЬКІСТЬ МЕШКАНЦІВ' },
  { number: '294', label: 'КІЛЬКІСТЬ КВАРТИР' },
];

export const CTA = {
  title: 'Група у Viber',
  text:
    'З метою організації спілкування між співвласниками та правлінням; обговорення проблем, ініціатив та порядку денного загальних зборів; оперативного повідомлення важливої інформації та пересилання документів створена група у Viber “Актив Гмирі 777”. ',
...
export const DOC_TABS: DocTab[] = [
  {
    ...
    cards: [
      ...
      { title: 'Статут ОСББ<br/>“Синевирій”', href: '/dokumenty/statut/' },
      { title: 'Протокол загальних зборів ОСББ “Синевирій”', href: '/dokumenty/protokol-zboriv/' },
    ],
  },
  {
    label: 'Законодавство',
...
export const CONTACTS = {
  ...
  scheduleText: 'Графік роботи: Пн – Пт з 09:00 до 18:00, перерва з 13:00 до 14:00',
  items: [
    { icon: 'map-marker-alt', html: '<strong>02140, Київ, вулиця Бориса Гмирі, будинок 777</strong>' },
    { icon: 'envelope', html: '<strong>sin@ukr.net</strong>' },
    { icon: 'phone-alt', html: '<strong> 044 000 11 22</strong>, <strong>067 000 11 22</strong>' },
    { icon: 'phone-alt', html: '<strong>044 587 86 40 – Аварійна служба</strong>' },
    { icon: 'phone-alt', html: '<strong>044 573 17 48 – Ліфтова служба</strong>' },
  ],
  mapSrc:
    'https://www.google.com/maps?q=%D0%9A%D0%B8%D1%97%D0%B2%2C%20%D0%91%D0%BE%D1%80%D0%B8%D1%81%D0%B0%20%D0%93%D0%BC%D0%B8%D1%80%D1%96%20777&hl=uk&z=15&output=embed',
  mapHeight: 248,
};
